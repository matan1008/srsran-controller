...
def test_editing_subscribers(users_db_file):
    ...
    assert users_db_file.read_text() == (
        'New Name!,mil,001010123456785,00112233445566778899aabbccddeeff,opc,63bfa50ee6523365ff14c1f45f88737d,9001,1233,'
        '9,dynamic\n'
        'Name2,mil,001010123456783,00112233445566778899aabbccddeeff,opc,63bfa50ee6523365ff14c1f45f88737d,9001,1233,'
        '9,dynamic\n'
    )
